...
class PlanningGraph():
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for precondition_a in node_a1.parents:
            for precondition_b in node_a2.parents:
                if precondition_a.is_mutex(precondition_b):
                    return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for precondition_a in node_s1.parents:
            for precondition_b in node_s2.parents:
                if not precondition_a.is_mutex(precondition_b):
                    return False
        return True
